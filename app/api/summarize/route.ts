...
const mockEntries = [
  ...
  // --- Estate Planning cluster ---
  {
    ...
    content:
      "GRATs allow transfer of appreciation above the IRS 7520 rate to beneficiaries gift-tax free. Zeroed-out GRATs are most common. Ideal in low-interest-rate environments. Risk: grantor must survive the GRAT term. Walton GRAT strategy minimizes mortality risk. Current 7520 rate: 5.0% — still viable for high-growth assets like closely held business interests.",
    type: "planning",
    topic: "Estate Planning",
    status: "approved",
    isPrivate: false,
  ...
  },
  {
    ...
    content:
      "CRTs provide income stream to donor (or other non-charitable beneficiary) for life or term, remainder to charity. Donor receives upfront charitable deduction based on present value of remainder interest. No capital gains on appreciated property contributed. Unitrust (CRUT) vs annuity trust (CRAT) distinction. Combine with life insurance replacement trust for heirs. Minimum 10% remainder value requirement.",
    type: "planning",
    topic: "Estate Planning",
    status: "approved",
    isPrivate: false,
  ...
  // --- Business Taxation cluster ---
  {
    ...
    content:
      "IRS requires S-Corp shareholder-employees to receive reasonable W-2 wages before taking distributions. Failure exposes shareholders to employment tax on distributions recharacterized as wages. Reasonable compensation benchmarks: industry surveys, BLS data, comparable salaries. Recent IRS audit focus area. Formula approach: duties test, company size, training/experience. Document the analysis annually.",
    type: "tax",
    topic: "Business Taxation",
    status: "approved",
    isPrivate: false,
  ...
  // --- Retirement Planning cluster ---
  {
    ...
    content:
      "2025 contribution limits: Traditional/Roth IRA $7,000 ($8,000 age 50+). 401(k)/403(b) elective deferrals $23,500 ($31,000 age 50+; $34,750 age 60-63 under SECURE 2.0 super catch-up). SIMPLE IRA $16,500. Roth IRA phase-out: $150,000-$165,000 (single), $236,000-$246,000 (MFJ). Backdoor Roth strategy still viable for high earners. SEP IRA: lesser of 25% of compensation or $70,000.",
    type: "planning",
  ...
  // --- GAAP Standards cluster ---
  {
    ...
    content:
      "Five-step model: identify contract, identify performance obligations, determine transaction price, allocate price, recognize revenue. Common issues: variable consideration (constraint analysis), principal vs agent determination, licenses (right to use vs right to access). Contract modifications prospective vs cumulative catch-up. Disclosure requirements are extensive — disaggregated revenue, contract balances, performance obligations. Software: term licenses vs SaaS distinction critical.",
    type: "accounting",
    topic: "GAAP Standards",
    status: "approved",
    isPrivate: false,
  ...
  },
  {
    ...
    content:
      "CECL requires lifetime expected credit loss estimates at origination — replaces incurred loss model. Small private companies and nonprofits adopted for fiscal years beginning after 12/15/2022. Practical expedients: collateral-dependent assets, zero-credit-loss assets. Common methods: loss rate, roll rate, discounted cash flow, PD/LGD. Qualitative overlays still required. Significant increase in documentation burden vs prior GAAP.",
    type: "accounting",
    topic: "GAAP Standards",
    status: "approved",
    isPrivate: false,
